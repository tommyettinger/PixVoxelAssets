...
namespace AssetsPV
{
    class ForaysPalettes
    {
        ...
        public static float[][][] wpalettes = new float[][][]
            ...
            new float[] {0.45F,0.4F,0.15F,1F},
            //2 pants, jeans contrast
            new float[] {0.4F,0.22F,0.05F,1F},
            //3 pants, jeans
            new float[] {0.55F,0.35F,0.15F,1F},
            //4 shirt contrast
            new float[] {0.6F,0.1F,-0.05F,1F},
            //5 shirt
            new float[] {0.75F,0.2F,0.05F,1F},
            //6 hair contrast
            new float[] {0.15F,0.1F,0.1F,1F},
            //7 hair
            new float[] {0.25F,0.2F,0.2F,1F},
            //8 skin contrast
            new float[] {0.13F,0.3F,0.02F,1F},
            //9 skin
            new float[] {0.2F,0.5F,0.1F,1F},
            //10 eyes shine
            new float[] {1.4F,0.6F,0.6F,1F},
            //11 eyes
            new float[] {0.25F,0.1F,0.0F,1F},
            //12 metal contrast
            new float[] {0.7F,0.75F,0.85F,1F},
            //13 metal
            new float[] {0.5F,0.53F,0.6F,1F},
            ...
            new float[][] { //13 stones
                //0 stone contrast
                new float[] {0.52F,0.48F,0.4F,1F},
                //1 stone
                new float[] {0.65F,0.6F,0.52F,1F},
                //2 mud/dirt contrast
                new float[] {0.5F,0.41F,0.32F,1F},
                //3 mud/dirt
                new float[] {0.6F,0.52F,0.45F,1F},
                //4 grassy ground contrast
                new float[] {0.22F,0.6F,0.05F,1F},
                //5 grassy ground
                new float[] {0.35F,0.75F,0.15F,1F},
                ...
                //28 fuzz deepest
                new float[] { 0.22F, 0.41F, 0.6F, fuzz_alpha},
                //29 fuzz deep
                new float[] { 0.3F, 0.5F, 0.7F, fuzz_alpha},
                //30 fuzz mid-deep
                new float[] { 0.38F, 0.59F, 0.8F, fuzz_alpha},
                //31 fuzz mid-light
                new float[] { 0.46F, 0.68F, 0.9F, fuzz_alpha},
                //32 fuzz light
                new float[] { 0.54F, 0.77F, 1.0F, fuzz_alpha},
                //33 fuzz lightest
                new float[] { 0.61F, 0.9F, 1.12F, fuzz_alpha},
                //34 gore
                new float[] {0.67F,0.05F,-0.1F,1F},
                //35 glass
                new float[] {0.5F,0.8F,1.1F,1F},
            ...
            new float[][] { //14 grass and plants
                ...
                new float[] {0.15F,0.55F,0.1F,1F},
                //4 grassy ground contrast
                new float[] {0.18F,0.4F,0.05F,1F},
                //5 grassy ground
                new float[] {0.25F,0.55F,0.12F,1F},
                //6 dead leaves contrast
                new float[] {0.7F,0.57F,0.45F,1F},
                //7 dead leaves
                new float[] {0.78F,0.7F,0.55F,1F},
        ...
        public static void Initialize()
        {
            ...
            VoxelLogic.subtlePalettes = new int[] { 7, 8, 13, 14, wpc, wpc + 1, wpc + 2, wpc + 3, wpc + 4, wpc + 5, wpc + 6, wpc + 7, wpc + 8, wpc + 9, wpc + 10 };
